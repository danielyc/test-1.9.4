...
public class ChunkProviderServer implements IChunkProvider
{
    ...
    public Chunk loadChunk(int X, int Z, Runnable runnable)
    {
        ...
        Chunk chunk = this.id2ChunkMap.get(pos);
    ...
    public Chunk originalLoadChunk(int x, int z)
    {
        ...
        if (chunk == null)
        {
            ...
            {
                net.minecraftforge.fml.common.FMLLog.bigWarning("There is an attempt to load a chunk (%d,%d) in di    >mension %d that is already being loaded. This will cause weird chunk breakages.", x, z, this.worldObj.provider.getDimension());
            }
